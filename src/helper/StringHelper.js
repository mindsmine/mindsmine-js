    ...
    return {
        ...
        htmlEncode: function (str) {
            if (str != null && typeof str === "string") {
                var __firstParse = document.createElement("a").appendChild(document.createTextNode(str)).parentNode.innerHTML;
        ...
        htmlDecode: function (str) {
            if (str != null && typeof str === "string") {
                var __parser = document.createElement("a");
        ...
        /**
         * Appends content to the query string of a URL, handling logic for whether to place a question mark or
         * ampersand.
         *
